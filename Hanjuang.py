...
# WhatsApp Group Link
channel_link = "https://chat.whatsapp.com/IhRpmNrAyet9D8hXDGRLgU?mode=hqrt3_copy_t"

# Valid keys
approved_keys = ["Hanjuang"]

def first_step():
    os.system("clear")
    print("────────────────────────────────────")
    print("     🔐 Script Terkunci 🔐")
    print("────────────────────────────────────\n")

    print("\033[1;32m JOIN OUR WHATSAPP GROUPS ✅\033[0m\n")

    # 👉 WhatsApp Group Auto-Open
    os.system("termux-open-url https://chat.whatsapp.com/IhRpmNrAyet9D8hXDGRLgU?mode=hqrt3")

    # 👉 Youtube Channel Auto-Open
    os.system("termux-open-url https://youtube.com/@naturalfrequencyxyz?si=X511XbvEpYVE3YQT")
...
os.system('clear')
print(' \x1b[38;5;46m Hanjuang SERVER LOADING....')
...
os.system('clear')
os.system("xdg-open 'https://chat.whatsapp.com/IhRpmNrAyet9D8hXDGRLgU?mode=hqrt3mode=ems_copy_t'")
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【HANJUANG NANGTUNG】𓆪 \x07')
